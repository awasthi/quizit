...
<form method="post" action="<?php echo site_url('qbank/add_new/2');?>">
<table id="formdata">
...
<tr><td valign="top">Answer</td><td valign="top">
</td></tr>
<tr><td valign="top">1) &nbsp;&nbsp;</td><td valign="top">
<input type="text" name="option[]" placeholder="Answer"> 
<br>User input will be matched with it. Not case sensitive
</td></tr>
