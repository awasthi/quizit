...
<form method="post" action="<?php echo site_url('qbank/add_new/3');?>">
<table id="formdata">
...
<input type="text" name="option[]" placeholder="Answer"><br> Give comma separated answer (Eg: answer1,answer2). User input will be matched with any one. Not case sensitive</td></tr>
