...
<input type="button" id="starttestbtn" Value="<?php if($this->config->item('webcam_plugin') == true && $result->camera_req == '1'){ echo 'Capture my photo and '; } ?> Start Test" onClick="javascript:checkbox_validate();"  class="button-warning pure-button" style="cursor:pointer;">
<?php
if($this->config->item('webcam_plugin') == true && $result->camera_req == "1"){
?>
